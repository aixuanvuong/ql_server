      ...
      <div className="bg-slate-900 border border-slate-700/80 rounded-2xl w-full max-w-xl shadow-2xl overflow-hidden flex flex-col max-h-[92vh]">
        ...
        <div className="px-5 py-4 border-b border-slate-800 flex items-center justify-between bg-slate-900/90">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-sky-500/10 border border-sky-500/30 text-sky-400 flex items-center justify-center flex-shrink-0 shadow-inner">
        ...
        <div className="p-5 overflow-y-auto space-y-4">
          ...
          {showGuide && (
            <div className="p-4 rounded-xl bg-sky-950/40 border border-sky-500/30 text-xs text-slate-300 space-y-2.5 animate-in slide-in-from-top-2 duration-150">
              ...
              <ol className="list-decimal list-inside space-y-1.5 text-slate-300 pl-1 leading-relaxed">
                <li>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="text-sky-400 font-semibold underline hover:text-sky-300 inline-flex items-center gap-0.5"
                  >
                    @BotFather <ExternalLink className="w-3 h-3" />
                  </a>
                  , gửi lệnh <code className="bg-slate-900 px-1.5 py-0.5 rounded text-sky-300 font-mono">/newbot</code> và làm theo hướng dẫn để nhận Token.
                </li>
                <li>
                  Tìm kiếm bot{' '}
                  <a
                ...
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    {config.botInfo?.username && (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="text-[11px] px-2 py-0.5 rounded-md bg-sky-500/20 text-sky-300 hover:bg-sky-500/30 flex items-center gap-1 font-mono transition-colors"
                      >
                        @{config.botInfo.username}
                  ...
                  <div className="text-[11px] text-slate-400 mt-0.5 font-mono">
                    {config.hasToken ? (
                      ...
                      <span className="text-amber-400/90">Chưa nhập Token từ BotFather</span>
                    )}
                    {config.adminId && (
          ...
          <form onSubmit={handleSave} className="space-y-4">
            ...
            <div className="flex items-center justify-between p-3 rounded-xl bg-slate-950/50 border border-slate-800/80">
              <div className="flex items-center gap-2.5">
                <Power className={`w-4 h-4 ${enabledInput ? 'text-emerald-400' : 'text-slate-500'}`} />
                <div>
                  <div className="text-xs font-semibold text-white">Kích hoạt Telegram ChatOps</div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 font-mono transition-all pr-20"
                />
                <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1">
                  ...
                  <button
                    ...
                    className="px-2 py-1 rounded bg-slate-800 hover:bg-slate-700 text-sky-400 text-[10px] font-semibold transition-colors disabled:opacity-50 cursor-pointer"
                  >
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 font-mono transition-all"
                />
              </div>
              <p className="text-[11px] text-slate-400">
                <strong className="text-rose-400">Cơ chế an toàn:</strong> Bot sẽ tự động chặn và từ chối mọi người lạ có Chat ID không khớp với giá trị này.
              </p>
            </div>
